...
class FWindow(FramelessWindow, EnginePart):
    def __init__(self):
        super().__init__()
    ...
    def initNavigation(self):
        self.__addSubInterface(self.searchInterface, FIF.SEARCH, "Search")
        self.__addSubInterface(self.musicInterface, FIF.MUSIC, "Music library")
        self.__addSubInterface(self.videoInterface, FIF.VIDEO, "Video library")
    ...
    def __addSubInterface(
        ...
        if not isinstance(interface, QWidget):
            frame = QFrame(self)
            frame.setLayout(interface)

            self.stackWidget.addWidget(frame)
        ...
        self.navigationInterface.addItem(
            ...
            icon=icon,
            text=text,
            onClick=lambda: self.switchTo(frame),
            position=position,
            tooltip=text,
        )
